...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark" style="background-color: darkcyan;" aria-label="Main navigation">
  <div class="container-fluid">
    <a class="navbar-brand" href="/">PARSHWANT ELECTRONICS</a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      ...
      <form class="d-flex" role="search">
        ...
        <a class="" style="text-decoration: none; color: white" href="/profile">Hello, {{ session()->get('email')}} </a>
        @endif
        ...
        <a class="btn btn-sm btn-outline-light" href="/register">Sign up</a>
        @endif

        @if (session()->has('email'))
        <a class="btn btn-sm btn-outline-light" href="/logout">Log out</a>
        @endif        
