                        ...
                        <tbody>
                            ...
                            @foreach ($invoice as $inv)
                                <tr>
                                    ...
                                    <td style="text-align: left;">
                                        <a href="/creditnote/store/{{ $inv->id }}">
                                            <i class="fa  fa-credit-card" style="color: steelblue;" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td style="text-align: left;"><a href="/invoices/show/{{ $inv->id }}"><i
                                                class="fa fa-eye" aria-hidden="true"></i></a></td>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-2">
                                                ...
                                                <input type="date" class="form-control form-control-sm" value="{{ date('Y-m-d') }}" id="credit_date" name="credit_date">
                                            </div>
                                            <div class="col-sm-1">
                                            ...
                                            <div class="col-sm-2">
                                                <label for="on_account_received" class="form-label">On Account Received</label>
                                                <input type="number" class="form-control form-control-sm" id="on_account_received" name="on_account_received">
                                            </div>
                                            <div class="col-sm-2">
